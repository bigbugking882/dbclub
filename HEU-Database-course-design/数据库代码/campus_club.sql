...
-- 2. 社团数据
INSERT INTO `club` (`club_name`, `description`, `founder_id`, `create_time`, `status`, `category`) VALUES
('计算机协会', '计算机技术交流与学习，编程技术分享', 1, '2024-01-15', 1, '学术科技'),
('篮球社', '篮球运动爱好者聚集地，定期组织比赛', 2, '2024-02-20', 1, '文化体育'),
('志愿者协会', '组织各类志愿服务活动，服务社会', 1, '2024-03-10', 1, '志愿公益'),
('英语角', '英语学习交流平台，提高口语能力', 3, '2024-01-25', 1, '学术科技'),
('舞蹈社', '舞蹈爱好者社团，学习各种舞蹈风格', 4, '2024-02-15', 1, '文化体育'),
('摄影协会', '摄影技术交流，组织外拍活动', 5, '2024-03-05', 1, '文化体育')
ON DUPLICATE KEY UPDATE 
...
-- 4. 活动数据
INSERT INTO `activity` (`club_id`, `title`, `content`, `start_time`, `end_time`, `location`, `status`) VALUES
-- 计算机协会活动
(1, 'Python入门讲座', 'Python基础语法与环境搭建，适合零基础学员', '2024-12-01 14:00:00', '2024-12-01 16:00:00', '教学楼201教室', 0),
(1, 'Web开发实战', 'HTML、CSS、JavaScript前端开发实战', '2024-12-08 15:00:00', '2024-12-08 17:00:00', '计算机实验室', 0),
(1, '算法竞赛培训', 'ACM竞赛算法讲解与实战训练', '2024-11-25 19:00:00', '2024-11-25 21:00:00', '教学楼305教室', 1),

-- 篮球社活动
(2, '校园篮球联赛', '各学院篮球代表队参赛，精彩对决', '2024-12-05 16:00:00', '2024-12-05 18:00:00', '体育馆篮球场', 0),
(2, '篮球基础训练', '篮球基本功教学，适合初学者', '2024-11-28 17:00:00', '2024-11-28 19:00:00', '室外篮球场', 1),

-- 志愿者协会活动
(3, '社区环保活动', '清理社区垃圾，宣传环保知识', '2024-12-02 09:00:00', '2024-12-02 12:00:00', '学校周边社区', 0),
(3, '敬老院慰问', '看望敬老院老人，表演文艺节目', '2024-11-30 14:00:00', '2024-11-30 17:00:00', '阳光敬老院', 1),

-- 英语角活动
(4, '英语口语角', '自由英语对话，提高口语表达能力', '2024-12-03 19:00:00', '2024-12-03 21:00:00', '外语学院活动室', 0),
(4, '英文电影欣赏', '观看英文电影，学习地道表达', '2024-11-29 18:30:00', '2024-11-29 21:00:00', '多媒体教室', 1),

-- 舞蹈社活动
(5, '街舞基础教学', '学习街舞基本动作和节奏感', '2024-12-04 19:00:00', '2024-12-04 21:00:00', '舞蹈排练厅', 0),
(5, '民族舞表演', '民族舞蹈排练和表演技巧', '2024-11-27 20:00:00', '2024-11-27 22:00:00', '艺术中心', 2),

-- 摄影协会活动
(6, '校园秋色外拍', '捕捉校园秋季美景，摄影技巧交流', '2024-12-06 15:00:00', '2024-12-06 17:00:00', '校园内', 0),
(6, '人像摄影讲座', '人像摄影构图与灯光技巧', '2024-11-26 19:00:00', '2024-11-26 21:00:00', '摄影工作室', 2)
ON DUPLICATE KEY UPDATE 
